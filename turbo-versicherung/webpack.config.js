...
const landingpageBuildConfig = new BuildConfig()
  .withName('turbo-versicherung-cx-22.0-landingpage')
...
const websiteBuildConfig = new BuildConfig()
  .withName('turbo-versicherung-cx-22.0-website')
  .withVersion(package.version)
...
module.exports = WebpackConfigBuilder.fromConfigs(
  websiteBuildConfig.clone()
    .withName('turbo-versicherung-cx-1.3-website-de')
    .withTargetVersion(Version.CX_1_3)
    .withPropertiesFilePath(path.resolve(__dirname, 'properties-de.js')),
  /*websiteBuildConfig.clone()
    .withName('turbo-versicherung-cx-1.3-website-en')
    .withTargetVersion(Version.CX_1_3)
    .withPropertiesFilePath(path.resolve(__dirname, 'properties-en.js')),*/
  websiteBuildConfig.clone()
    .withName('turbo-versicherung-cx-22.0-website-de')
    .withPropertiesFilePath(path.resolve(__dirname, 'properties-de.js')),
  /*websiteBuildConfig.clone()
    .withName('turbo-versicherung-cx-22.0-website-en')
    .withPropertiesFilePath(path.resolve(__dirname, 'properties-en.js')),*/
  landingpageBuildConfig.clone()
    .withName('turbo-versicherung-cx-1.3-landingpage-de')
    .withTargetVersion(Version.CX_1_3)
    .withPropertiesFilePath(path.resolve(__dirname, 'properties-de.js')),
  /*landingpageBuildConfig.clone()
    .withName('turbo-versicherung-cx-1.3-landingpage-en')
    .withTargetVersion(Version.CX_1_3)
    .withPropertiesFilePath(path.resolve(__dirname, 'properties-en.js')),*/
  landingpageBuildConfig.clone()
    .withName('turbo-versicherung-cx-22.0-landingpage-de')
    .withPropertiesFilePath(path.resolve(__dirname, 'properties-de.js')),
  /*landingpageBuildConfig.clone()
    .withName('turbo-versicherung-cx-22.0-landingpage-en')
    .withPropertiesFilePath(path.resolve(__dirname, 'properties-en.js'))*/);